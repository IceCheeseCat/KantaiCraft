...
//
//    protected CarrierShip(EntityType<? extends PathfinderMob> entityType, Level level, EntityStance entityStance) {
//        super(entityType, ShipClass.AIRCRAFT_CARRIER, level, ATTACKABLE_TYPES, entityStance);
//    }
//
//    @Override
