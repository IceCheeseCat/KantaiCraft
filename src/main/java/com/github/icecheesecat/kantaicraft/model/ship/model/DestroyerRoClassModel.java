...
public class DestroyerRoClassModel<T extends DestroyerRoClass> extends EntityModel<T> {
    ...
    public DestroyerRoClassModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(DestroyerRoClass entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
