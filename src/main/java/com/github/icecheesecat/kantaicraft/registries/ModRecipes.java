...
//		ItemStack abyssiumNugget = new ItemStack(ModItem.AbyssNugget, 1, 0);
//		ItemStack abyssiumNugget9 = new ItemStack(ModItem.AbyssNugget, 9, 0);
//		ItemStack abyssiumStack = new ItemStack(ModItem.AbyssMetal,1,0);
//		ItemStack abyssiumStack9 = new ItemStack(ModItem.AbyssMetal,9,0);
//		ItemStack ammo1 = new ItemStack(ModItem.Ammo,1,0);
//		ItemStack ammo8 = new ItemStack(ModItem.Ammo,8,0);
//		ItemStack ammo9 = new ItemStack(ModItem.Ammo,9,0);
//		ItemStack ammo16 = new ItemStack(ModItem.Ammo,16,0);
//		ItemStack ammo32 = new ItemStack(ModItem.Ammo,32,0);
//		ItemStack ammo64 = new ItemStack(ModItem.Ammo,64,0);
//		ItemStack ammoContainer = new ItemStack(ModItem.Ammo,1,1);
//		ItemStack ammoHeavy1 = new ItemStack(ModItem.Ammo,1,2);
//		ItemStack ammoHeavy2 = new ItemStack(ModItem.Ammo,2,2);
//		ItemStack ammoHeavy4 = new ItemStack(ModItem.Ammo,4,2);
//		ItemStack ammoHeavy8 = new ItemStack(ModItem.Ammo,8,2);
//		ItemStack ammoHeavy9 = new ItemStack(ModItem.Ammo,9,2);
//		ItemStack ammoHeavyContainer = new ItemStack(ModItem.Ammo,1,3);
//		ItemStack blazepowderStack = new ItemStack(Items.BLAZE_POWDER);
//		ItemStack bucketRepairStack = new ItemStack(ModItem.BucketRepair);
//		ItemStack desk = new ItemStack(ModBlocks.BlockDesk);
//		ItemStack deskBook = new ItemStack(ModItem.DeskItemBook);
//		ItemStack deskRadar = new ItemStack(ModItem.DeskItemRadar);
//		ItemStack grudeStack = new ItemStack(ModItem.Grudge);
//		ItemStack grudeStack9 = new ItemStack(ModItem.Grudge,9,0);
...
//		ItemStack grudeXPStack = new ItemStack(ModItem.Grudge, 1, 1);
...
//		ItemStack instantMat8 = new ItemStack(ModItem.InstantConMat, 8);
//		ItemStack instantMat32 = new ItemStack(ModItem.InstantConMat, 64);
//		ItemStack ironBlock = new ItemStack(Blocks.IRON_BLOCK);
//		ItemStack kaitaiHammerNew = new ItemStack(ModItem.KaitaiHammer);
//		ItemStack kaitaiHammerAll = new ItemStack(ModItem.KaitaiHammer, 1, OreDictionary.WILDCARD_VALUE);
//		ItemStack modernKit = new ItemStack(ModItem.ModernKit);
//		ItemStack magma = new ItemStack(Blocks.MAGMA);
//		ItemStack ownerPaper = new ItemStack(ModItem.OwnerPaper);
//		ItemStack pointer = new ItemStack(ModItem.PointerItem);
//		ItemStack polymetalNugget = new ItemStack(ModItem.AbyssNugget, 1, 1);
//		ItemStack polymetalNugget9 = new ItemStack(ModItem.AbyssNugget, 9, 1);
//		ItemStack polymetalStack = new ItemStack(ModItem.AbyssMetal, 1, 1);
//		ItemStack polymetalStack4 = new ItemStack(ModItem.AbyssMetal, 4, 1);
//		ItemStack polymetalStack5 = new ItemStack(ModItem.AbyssMetal, 5, 1);
//		ItemStack polymetalStack9 = new ItemStack(ModItem.AbyssMetal, 9, 1);
...
//		ItemStack ring = new ItemStack(ModItem.MarriageRing);
//		ItemStack repairGoddess = new ItemStack(ModItem.RepairGoddess,1,0);
//		ItemStack shipEgg = new ItemStack(ModItem.ShipSpawnEgg, 1, OreDictionary.WILDCARD_VALUE);	//for all meta value
//		ItemStack shipEggS = new ItemStack(ModItem.ShipSpawnEgg, 1, 0);
//		ItemStack shipEggL = new ItemStack(ModItem.ShipSpawnEgg, 1, 1);
//		ItemStack smallshipyardStack = new ItemStack(ModBlocks.BlockSmallShipyard);
//		ItemStack toyplane = new ItemStack(ModItem.ToyAirplane);
//		ItemStack trainbook = new ItemStack(ModItem.TrainingBook);
//		ItemStack wrench = new ItemStack(ModItem.TargetWrench);
...
//		ItemStack ration0 = new ItemStack(ModItem.CombatRation, 1, 0);
//		ItemStack ration1 = new ItemStack(ModItem.CombatRation, 1, 1);
//		ItemStack ration2 = new ItemStack(ModItem.CombatRation, 1, 2);
//		ItemStack ration3 = new ItemStack(ModItem.CombatRation, 1, 3);
//		ItemStack ration4 = new ItemStack(ModItem.CombatRation, 1, 4);
//		ItemStack ration5 = new ItemStack(ModItem.CombatRation, 1, 5);
//		ItemStack shiptank0 = new ItemStack(ModItem.ShipTank, 1, 0);
//		ItemStack shiptank1 = new ItemStack(ModItem.ShipTank, 1, 1);
//		ItemStack shiptank2 = new ItemStack(ModItem.ShipTank, 1, 2);
//		ItemStack shiptank3 = new ItemStack(ModItem.ShipTank, 1, 3);
//		ItemStack recipepaper = new ItemStack(ModItem.RecipePaper);
//
//		//SHAPELESS RECIPE
//		//abyssium material:
...
//		GameRegistry.addRecipe(new ShapelessOreRecipe(ration4, Items.SNOWBALL, Items.SNOWBALL, Items.SNOWBALL, Items.SNOWBALL, Items.MILK_BUCKET, ModItem.Grudge));
