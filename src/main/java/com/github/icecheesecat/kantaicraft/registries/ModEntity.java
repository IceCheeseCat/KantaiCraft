...
public class ModEntity {
    ...
    public static final RegistryObject<EntityType<Akatsuki>> AKATSUKI =
            registerPlayerShip(Akatsuki.PlayerSide::new, "akatsuki", 0.8f, 1.6f);

    public static final RegistryObject<EntityType<Inazuma>> HOSTILE_INAZUMA =
            registerHostileShip(Inazuma.HostileSide::new, "hostile_inazama", 0.8f, 1.4f);
    public static final RegistryObject<EntityType<Ikazuchi>> HOSTILE_IKAZUCHI =
            registerHostileShip(Ikazuchi.HostileSide::new, "hostile_ikazuchi", 0.8f, 1.4f);
    public static final RegistryObject<EntityType<Hibiki>> HOSTILE_HIBIKI =
            registerHostileShip(Hibiki.HostileSide::new, "hostile_hibiki", 0.8f, 1.4f);
    public static final RegistryObject<EntityType<Akatsuki>> HOSTILE_AKATSUKI =
            registerHostileShip(Akatsuki.HostileSide::new, "hostile_akatsuki", 0.8f, 1.4f);
