...
import com.github.icecheesecat.kantaicraft.entity.ship.CarrierShip;
...
public class CarrierBrain {
    ...
    public static Brain<BasicEntityPlane> makeBrain(CarrierShip ship, Dynamic<?> dyn) {
    ...
    private static void initCoreActivity(CarrierShip ship, Brain<BasicEntityPlane> brain) {
