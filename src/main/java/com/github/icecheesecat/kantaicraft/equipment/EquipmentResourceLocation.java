...
public class EquipmentResourceLocation {
    ...
    static {
        ALL_EQUIPMENTS_RESOURCE_LOCATION.put(Equipments.__12cm_single_gun_mount__.getUid(), new ResourceLocation(KantaiCraft.MODID, "textures/equipment/12cm_small_gun_mount.png"));
    }
