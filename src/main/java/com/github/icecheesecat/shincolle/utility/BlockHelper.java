//package com.github.icecheesecat.shincolle.utility;
//
...
//	public static final FluidStack SampleFluidLava = new FluidStack(Fluids.LAVA, 1000);
//	public static final FluidStack SampleFluidWater = new FluidStack(Fluids.WATER, 1000);
//
//
//	public BlockHelper() {}
//
...
//	 */
//	public static int[] getSafeBlockWithin5x5(Level world, int x, int y, int z)
//	{
...
//	 */
//	public static int[] getSafeBlockWithinRange(Level world, int x, int y, int z, int ranX, int ranY, int ranZ)
//	{
