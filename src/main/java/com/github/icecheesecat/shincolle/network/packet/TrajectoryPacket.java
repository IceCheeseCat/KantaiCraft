package com.github.icecheesecat.shincolle.network.packet;
...
public class TrajectoryPacket {
    ...
    @Mod.EventBusSubscriber(modid = Shincolle.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
