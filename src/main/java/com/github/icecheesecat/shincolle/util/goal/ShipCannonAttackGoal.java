package com.github.icecheesecat.shincolle.util.goal;

import com.github.icecheesecat.shincolle.config.ConfigBehaviour;
            ...
            case LOSS_TARGET_SIGHT -> {
                if (!doTargeting()) {
                    if (redirectTimer < 0) {
                        ...
                        Path path = pathNavigation.createPath(target, (int) this.ship.getShipAttrs().getLos());
